...
export class AccountApi {
     ...
     */
    public getAccount (options: any = {}) : Promise<{ response: AxiosResponse; body: GetAccount;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetAccount;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
				let {data} = response;
...
export class CompaniesApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public companiesAttributesGet (options: any = {}) : Promise<{ response: AxiosResponse; body: CompanyAttributes;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: CompanyAttributes;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
				let {data} = response;
     ...
     * @param {*} [options] Override http request options.
     */
    public companiesGet (filters?: string, linkedContactsIds?: number, linkedDealsIds?: string, page?: number, limit?: number, sort?: 'asc' | 'desc', sortBy?: string, options: any = {}) : Promise<{ response: AxiosResponse; body: CompaniesList;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: CompaniesList;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
				let {data} = response;
     ...
     * @param {*} [options] Override http request options.
     */
    public companiesIdDelete (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public companiesIdGet (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: Company;  }> {
        const localVarPath = this.basePath + '/companies/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: Company;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
				let {data} = response;
     ...
     * @param {*} [options] Override http request options.
     */
    public companiesIdPatch (id: string, body: Body1, options: any = {}) : Promise<{ response: AxiosResponse; body: Company;  }> {
        const localVarPath = this.basePath + '/companies/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     * @param {*} [options] Override http request options.
     */
    public companiesLinkUnlinkIdPatch (id: string, body: Body2, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            headers: localVarHeaderParams,
            url: localVarPath,
            data: ObjectSerializer.serialize(body, "Body2")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public companiesPost (body: Body, options: any = {}) : Promise<{ response: AxiosResponse; body: InlineResponse200;  }> {
        const localVarPath = this.basePath + '/companies';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            headers: localVarHeaderParams,
            url: localVarPath,
            data: ObjectSerializer.serialize(body, "Body")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: InlineResponse200;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
				let {data} = response
				data = ObjectSerializer.deserialize(body, "InlineResponse200");
				if (response.status && response.status >= 200 && response.status <= 299) {
					resolve({ response: response, body: data });
				} else {
					reject({ response: response, body: data });
...
export class ContactsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public addContactToList (listId: number, contactEmails: AddContactToList, options: any = {}) : Promise<{ response: AxiosResponse; body: PostContactInfo;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            headers: localVarHeaderParams,
            url: localVarPath,
            data: ObjectSerializer.serialize(contactEmails, "AddContactToList")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: PostContactInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
					let {data} = response;
                
                    data = ObjectSerializer.deserialize(data, "PostContactInfo");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public createAttribute (attributeCategory: 'normal' | 'transactional' | 'category' | 'calculated' | 'global', attributeName: string, createAttribute: CreateAttribute, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            headers: localVarHeaderParams,
            url: localVarPath,
            data: ObjectSerializer.serialize(createAttribute, "CreateAttribute")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public createContact (createContact: CreateContact, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateUpdateContactModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            headers: localVarHeaderParams,
            url: localVarPath,
            data: ObjectSerializer.serialize(createContact, "CreateContact")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateUpdateContactModel;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateUpdateContactModel");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public createDoiContact (createDoiContact: CreateDoiContact, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            headers: localVarHeaderParams,
            url: localVarPath,
            data: ObjectSerializer.serialize(createDoiContact, "CreateDoiContact")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public createFolder (createFolder: CreateUpdateFolder, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            headers: localVarHeaderParams,
            url: localVarPath,
            data: ObjectSerializer.serialize(createFolder, "CreateUpdateFolder")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateModel;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateModel");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public createList (createList: CreateList, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            headers: localVarHeaderParams,
            url: localVarPath,
            data: ObjectSerializer.serialize(createList, "CreateList")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteAttribute (attributeCategory: 'normal' | 'transactional' | 'category' | 'calculated' | 'global', attributeName: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/contacts/attributes/{attributeCategory}/{attributeName}'
            .replace('{' + 'attributeCategory' + '}', encodeURIComponent(String(attributeCategory)))
            .replace('{' + 'attributeName' + '}', encodeURIComponent(String(attributeName)));
        const localVarQueryParameters: any = {};
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteContact (identifier: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteFolder (folderId: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteList (listId: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getAttributes (options: any = {}) : Promise<{ response: AxiosResponse; body: GetAttributes;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetAttributes;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetAttributes");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
    ...
    public getContactInfo (identifier: string, startDate?: any, endDate?: any, options: any = {}) : Promise<{ response: AxiosResponse; body: GetExtendedContactDetails;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetExtendedContactDetails;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetExtendedContactDetails");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getContactStats (identifier: string, startDate?: string, endDate?: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetContactCampaignStats;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetContactCampaignStats;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetContactCampaignStats");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getContacts (limit?: number, offset?: number, modifiedSince?: string, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetContacts;  }> {
        const localVarPath = this.basePath + '/contacts';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetContacts;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetContacts");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getContactsFromList (listId: number, modifiedSince?: string, limit?: number, offset?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetContacts;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getFolder (folderId: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetFolder;  }> {
        const localVarPath = this.basePath + '/contacts/folders/{folderId}'
            .replace('{' + 'folderId' + '}', encodeURIComponent(String(folderId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: GetFolder;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetFolder");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getFolderLists (folderId: number, limit?: number, offset?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetFolderLists;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetFolderLists;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetFolderLists");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getFolders (limit: number, offset: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetFolders;  }> {
        const localVarPath = this.basePath + '/contacts/folders';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetFolders;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetFolders");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getList (listId: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetExtendedList;  }> {
        const localVarPath = this.basePath + '/contacts/lists/{listId}'
            .replace('{' + 'listId' + '}', encodeURIComponent(String(listId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: GetExtendedList;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetExtendedList");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getLists (limit?: number, offset?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetLists;  }> {
        const localVarPath = this.basePath + '/contacts/lists';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetLists;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetLists");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public importContacts (requestContactImport: RequestContactImport, options: any = {}) : Promise<{ response: AxiosResponse; body: CreatedProcessId;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: CreatedProcessId;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreatedProcessId");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public removeContactFromList (listId: number, contactEmails: RemoveContactFromList, options: any = {}) : Promise<{ response: AxiosResponse; body: PostContactInfo;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(contactEmails, "RemoveContactFromList")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public requestContactExport (requestContactExport: RequestContactExport, options: any = {}) : Promise<{ response: AxiosResponse; body: CreatedProcessId;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public updateAttribute (attributeCategory: 'category' | 'calculated' | 'global', attributeName: string, updateAttribute: UpdateAttribute, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/contacts/attributes/{attributeCategory}/{attributeName}'
            .replace('{' + 'attributeCategory' + '}', encodeURIComponent(String(attributeCategory)))
            .replace('{' + 'attributeName' + '}', encodeURIComponent(String(attributeName)));
        const localVarQueryParameters: any = {};
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updateAttribute, "UpdateAttribute")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public updateBatchContacts (updateBatchContacts: UpdateBatchContacts, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updateBatchContacts, "UpdateBatchContacts")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public updateContact (identifier: string, updateContact: UpdateContact, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/contacts/{identifier}'
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updateContact, "UpdateContact")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public updateFolder (folderId: number, updateFolder: CreateUpdateFolder, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/contacts/folders/{folderId}'
            .replace('{' + 'folderId' + '}', encodeURIComponent(String(folderId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updateFolder, "CreateUpdateFolder")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public updateList (listId: number, updateList: UpdateList, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/contacts/lists/{listId}'
            .replace('{' + 'listId' + '}', encodeURIComponent(String(listId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updateList, "UpdateList")
        };
...
export class ConversationsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public conversationsAgentOnlinePingPost (body: Body12, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body12")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public conversationsMessagesIdDelete (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public conversationsMessagesIdGet (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: ConversationsMessage;  }> {
        const localVarPath = this.basePath + '/conversations/messages/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: ConversationsMessage;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "ConversationsMessage");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public conversationsMessagesIdPut (id: string, body?: Body9, options: any = {}) : Promise<{ response: AxiosResponse; body: ConversationsMessage;  }> {
        const localVarPath = this.basePath + '/conversations/messages/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body9")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public conversationsMessagesPost (body: Body8, options: any = {}) : Promise<{ response: AxiosResponse; body: ConversationsMessage;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body8")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public conversationsPushedMessagesIdDelete (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public conversationsPushedMessagesIdGet (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: ConversationsMessage;  }> {
        const localVarPath = this.basePath + '/conversations/pushedMessages/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     * @param {*} [options] Override http request options.
     */
    public conversationsPushedMessagesIdPut (id: string, body: Body11, options: any = {}) : Promise<{ response: AxiosResponse; body: ConversationsMessage;  }> {
        const localVarPath = this.basePath + '/conversations/pushedMessages/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body11")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public conversationsPushedMessagesPost (body: Body10, options: any = {}) : Promise<{ response: AxiosResponse; body: ConversationsMessage;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body10")
        };
...
export class DealsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public crmAttributesDealsGet (options: any = {}) : Promise<{ response: AxiosResponse; body: DealAttributes;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: DealAttributes;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "DealAttributes");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmDealsGet (filtersAttributes?: string, filtersLinkedCompaniesIds?: string, filtersLinkedContactsIds?: string, offset?: number, limit?: number, sort?: 'asc' | 'desc', sortBy?: string, options: any = {}) : Promise<{ response: AxiosResponse; body: DealsList;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: DealsList;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "DealsList");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmDealsIdDelete (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public crmDealsIdGet (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: Deal;  }> {
        const localVarPath = this.basePath + '/crm/deals/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: Deal;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "Deal");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmDealsIdPatch (id: string, body: Body4, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/crm/deals/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body4")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public crmDealsLinkUnlinkIdPatch (id: string, body: Body5, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body5")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public crmDealsPost (body: Body3, options: any = {}) : Promise<{ response: AxiosResponse; body: InlineResponse201;  }> {
        const localVarPath = this.basePath + '/crm/deals';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body3")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: InlineResponse201;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "InlineResponse201");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmPipelineDetailsGet (options: any = {}) : Promise<{ response: AxiosResponse; body: Pipeline;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: Pipeline;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "Pipeline");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
...
export class EcommerceApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public createBatchOrder (orderBatch: OrderBatch, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(orderBatch, "OrderBatch")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public createOrder (order: Order, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public createUpdateBatchCategory (createUpdateBatchCategory: CreateUpdateBatchCategory, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateUpdateBatchCategoryModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(createUpdateBatchCategory, "CreateUpdateBatchCategory")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateUpdateBatchCategoryModel;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateUpdateBatchCategoryModel");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public createUpdateBatchProducts (createUpdateBatchProducts: CreateUpdateBatchProducts, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateUpdateBatchProductsModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(createUpdateBatchProducts, "CreateUpdateBatchProducts")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateUpdateBatchProductsModel;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateUpdateBatchProductsModel");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public createUpdateCategory (createUpdateCategory: CreateUpdateCategory, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateCategoryModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(createUpdateCategory, "CreateUpdateCategory")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateCategoryModel;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateCategoryModel");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public createUpdateProduct (createUpdateProduct: CreateUpdateProduct, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateProductModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(createUpdateProduct, "CreateUpdateProduct")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateProductModel;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateProductModel");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public ecommerceActivatePost (options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getCategories (limit?: number, offset?: number, sort?: 'asc' | 'desc', ids?: Array<string>, options: any = {}) : Promise<{ response: AxiosResponse; body: GetCategories;  }> {
        const localVarPath = this.basePath + '/categories';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetCategories;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetCategories");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
    ...
    public getCategoryInfo (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetCategoryDetails;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetCategoryDetails;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetCategoryDetails");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getProductInfo (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetProductDetails;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetProductDetails;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetProductDetails");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getProducts (limit?: number, offset?: number, sort?: 'asc' | 'desc', ids?: Array<string>, options: any = {}) : Promise<{ response: AxiosResponse; body: GetProducts;  }> {
        const localVarPath = this.basePath + '/products';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetProducts;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetProducts");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
...
export class EmailCampaignsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public createEmailCampaign (emailCampaigns: CreateEmailCampaign, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateModel;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteEmailCampaign (campaignId: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public emailExportRecipients (campaignId: number, recipientExport?: EmailExportRecipients, options: any = {}) : Promise<{ response: AxiosResponse; body: CreatedProcessId;  }> {
    ...
    public getAbTestCampaignResult (campaignId: number, options: any = {}) : Promise<{ response: AxiosResponse; body: AbTestCampaignResult;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: AbTestCampaignResult;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "AbTestCampaignResult");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getEmailCampaign (campaignId: number, statistics?: 'globalStats' | 'linksStats' | 'statsByDomain' | 'statsByDevice' | 'statsByBrowser', options: any = {}) : Promise<{ response: AxiosResponse; body: GetEmailCampaign;  }> {
        const localVarPath = this.basePath + '/emailCampaigns/{campaignId}'
            .replace('{' + 'campaignId' + '}', encodeURIComponent(String(campaignId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: GetEmailCampaign;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetEmailCampaign");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getEmailCampaigns (type?: 'classic' | 'trigger', status?: 'suspended' | 'archive' | 'sent' | 'queued' | 'draft' | 'inProcess', statistics?: 'globalStats' | 'linksStats' | 'statsByDomain', startDate?: string, endDate?: string, limit?: number, offset?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetEmailCampaigns;  }> {
        const localVarPath = this.basePath + '/emailCampaigns';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetEmailCampaigns;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetEmailCampaigns");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getSharedTemplateUrl (campaignId: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetSharedTemplateUrl;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetSharedTemplateUrl;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetSharedTemplateUrl");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public sendEmailCampaignNow (campaignId: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public sendReport (campaignId: number, sendReport: SendReport, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public sendTestEmail (campaignId: number, emailTo: SendTestEmail, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public updateCampaignStatus (campaignId: number, status: UpdateCampaignStatus, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public updateEmailCampaign (campaignId: number, emailCampaign: UpdateEmailCampaign, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/emailCampaigns/{campaignId}'
            .replace('{' + 'campaignId' + '}', encodeURIComponent(String(campaignId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     * @param {*} [options] Override http request options.
     */
    public uploadImageToGallery (uploadImage: UploadImageToGallery, options: any = {}) : Promise<{ response: AxiosResponse; body: UploadImageModel;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: UploadImageModel;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "UploadImageModel");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
...
export class FilesApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public crmFilesGet (entity?: 'companies' | 'deals' | 'contacts', entityIds?: string, dateFrom?: number, dateTo?: number, offset?: number, limit?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: FileList;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: FileList;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "FileList");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmFilesIdDataGet (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: FileData;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: FileData;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "FileData");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmFilesIdDelete (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public crmFilesIdGet (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: FileDownloadableLink;  }> {
        const localVarPath = this.basePath + '/crm/files/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: FileDownloadableLink;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "FileDownloadableLink");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmFilesPost (file: Buffer, dealId?: string, contactId?: number, companyId?: string, options: any = {}) : Promise<{ response: AxiosResponse; body: FileData;  }> {
        const localVarPath = this.basePath + '/crm/files';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
...
export class InboundParsingApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public getInboundEmailAttachment (downloadToken: string, options: any = {}) : Promise<{ response: AxiosResponse; body: Buffer;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: Buffer;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "Buffer");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getInboundEmailEvents (sender?: string, startDate?: string, endDate?: string, limit?: number, offset?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetInboundEmailEvents;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetInboundEmailEvents;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetInboundEmailEvents");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getInboundEmailEventsByUuid (uuid: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetInboundEmailEventsByUuid;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetInboundEmailEventsByUuid;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetInboundEmailEventsByUuid");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
...
export class MasterAccountApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public corporateMasterAccountGet (options: any = {}) : Promise<{ response: AxiosResponse; body: MasterDetailsResponse;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: MasterDetailsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "MasterDetailsResponse");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public corporateSubAccountGet (offset: number, limit: number, options: any = {}) : Promise<{ response: AxiosResponse; body: SubAccountsResponse;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: SubAccountsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "SubAccountsResponse");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public corporateSubAccountIdDelete (id: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
    ...
    public corporateSubAccountIdGet (id: number, options: any = {}) : Promise<{ response: AxiosResponse; body: SubAccountDetailsResponse;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: SubAccountDetailsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "SubAccountDetailsResponse");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public corporateSubAccountIdPlanPut (id: number, updatePlanDetails: SubAccountUpdatePlanRequest, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updatePlanDetails, "SubAccountUpdatePlanRequest")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public corporateSubAccountKeyPost (createApiKeyRequest: CreateApiKeyRequest, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateApiKeyResponse;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(createApiKeyRequest, "CreateApiKeyRequest")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateApiKeyResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateApiKeyResponse");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public corporateSubAccountPost (subAccountCreate: CreateSubAccount, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateSubAccountResponse;  }> {
        const localVarPath = this.basePath + '/corporate/subAccount';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(subAccountCreate, "CreateSubAccount")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateSubAccountResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateSubAccountResponse");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public corporateSubAccountSsoTokenPost (ssoTokenRequest: SsoTokenRequest, options: any = {}) : Promise<{ response: AxiosResponse; body: GetSsoToken;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(ssoTokenRequest, "SsoTokenRequest")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: GetSsoToken;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetSsoToken");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
...
export class NotesApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public crmNotesGet (entity?: 'companies' | 'deals' | 'contacts', entityIds?: string, dateFrom?: number, dateTo?: number, offset?: number, limit?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: NoteList;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: NoteList;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "NoteList");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmNotesIdDelete (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public crmNotesIdGet (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: Note;  }> {
        const localVarPath = this.basePath + '/crm/notes/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: Note;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "Note");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmNotesIdPatch (id: string, body: NoteData, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/crm/notes/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "NoteData")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public crmNotesPost (body: NoteData, options: any = {}) : Promise<{ response: AxiosResponse; body: NoteId;  }> {
        const localVarPath = this.basePath + '/crm/notes';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: NoteId;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "NoteId");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
...
export class ProcessApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public getProcess (processId: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetProcess;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetProcess;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetProcess");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getProcesses (limit?: number, offset?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetProcesses;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetProcesses;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetProcesses");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
...
export class ResellerApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public addCredits (childIdentifier: string, addCredits: AddCredits, options: any = {}) : Promise<{ response: AxiosResponse; body: RemainingCreditModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(addCredits, "AddCredits")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: RemainingCreditModel;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "RemainingCreditModel");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public associateIpToChild (childIdentifier: string, ip: ManageIp, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(ip, "ManageIp")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public createChildDomain (childIdentifier: string, addChildDomain: AddChildDomain, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(addChildDomain, "AddChildDomain")
        };
    ...
    public createResellerChild (resellerChild?: CreateChild, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateReseller;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(resellerChild, "CreateChild")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateReseller;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateReseller");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteChildDomain (childIdentifier: string, domainName: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteResellerChild (childIdentifier: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public dissociateIpFromChild (childIdentifier: string, ip: ManageIp, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getChildAccountCreationStatus (childIdentifier: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetChildAccountCreationStatus;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetChildAccountCreationStatus;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetChildAccountCreationStatus");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getChildDomains (childIdentifier: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetChildDomains;  }> {
        const localVarPath = this.basePath + '/reseller/children/{childIdentifier}/domains'
            .replace('{' + 'childIdentifier' + '}', encodeURIComponent(String(childIdentifier)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: GetChildDomains;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetChildDomains");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getChildInfo (childIdentifier: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetChildInfo;  }> {
        const localVarPath = this.basePath + '/reseller/children/{childIdentifier}'
            .replace('{' + 'childIdentifier' + '}', encodeURIComponent(String(childIdentifier)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: GetChildInfo;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetChildInfo");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getResellerChilds (limit?: number, offset?: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetChildrenList;  }> {
        const localVarPath = this.basePath + '/reseller/children';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetChildrenList;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetChildrenList");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getSsoToken (childIdentifier: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetSsoToken;  }> {
    ...
    public removeCredits (childIdentifier: string, removeCredits: RemoveCredits, options: any = {}) : Promise<{ response: AxiosResponse; body: RemainingCreditModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(removeCredits, "RemoveCredits")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public updateChildAccountStatus (childIdentifier: string, updateChildAccountStatus: UpdateChildAccountStatus, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updateChildAccountStatus, "UpdateChildAccountStatus")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public updateChildDomain (childIdentifier: string, domainName: string, updateChildDomain: UpdateChildDomain, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/reseller/children/{childIdentifier}/domains/{domainName}'
            .replace('{' + 'childIdentifier' + '}', encodeURIComponent(String(childIdentifier)))
            .replace('{' + 'domainName' + '}', encodeURIComponent(String(domainName)));
        const localVarQueryParameters: any = {};
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updateChildDomain, "UpdateChildDomain")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public updateResellerChild (childIdentifier: string, resellerChild: UpdateChild, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/reseller/children/{childIdentifier}'
            .replace('{' + 'childIdentifier' + '}', encodeURIComponent(String(childIdentifier)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(resellerChild, "UpdateChild")
        };
...
export class SMSCampaignsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public createSmsCampaign (createSmsCampaign: CreateSmsCampaign, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(createSmsCampaign, "CreateSmsCampaign")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteSmsCampaign (campaignId: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getSmsCampaign (campaignId: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetSmsCampaign;  }> {
        const localVarPath = this.basePath + '/smsCampaigns/{campaignId}'
            .replace('{' + 'campaignId' + '}', encodeURIComponent(String(campaignId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: GetSmsCampaign;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetSmsCampaign");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getSmsCampaigns (status?: 'suspended' | 'archive' | 'sent' | 'queued' | 'draft' | 'inProcess', startDate?: string, endDate?: string, limit?: number, offset?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetSmsCampaigns;  }> {
        const localVarPath = this.basePath + '/smsCampaigns';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetSmsCampaigns;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetSmsCampaigns");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public requestSmsRecipientExport (campaignId: number, recipientExport?: RequestSmsRecipientExport, options: any = {}) : Promise<{ response: AxiosResponse; body: CreatedProcessId;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(recipientExport, "RequestSmsRecipientExport")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public sendSmsCampaignNow (campaignId: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public sendSmsReport (campaignId: number, sendReport: SendReport, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public sendTestSms (campaignId: number, phoneNumber: SendTestSms, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(phoneNumber, "SendTestSms")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public updateSmsCampaign (campaignId: number, updateSmsCampaign: UpdateSmsCampaign, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/smsCampaigns/{campaignId}'
            .replace('{' + 'campaignId' + '}', encodeURIComponent(String(campaignId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updateSmsCampaign, "UpdateSmsCampaign")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public updateSmsCampaignStatus (campaignId: number, status: UpdateCampaignStatus, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
...
export class SendersApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public createSender (sender?: CreateSender, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateSenderModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(sender, "CreateSender")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateSenderModel;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateSenderModel");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteSender (senderId: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getIps (options: any = {}) : Promise<{ response: AxiosResponse; body: GetIps;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetIps;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetIps");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getIpsFromSender (senderId: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetIpsFromSender;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetIpsFromSender;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetIpsFromSender");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
    ...
    public getSenders (ip?: string, domain?: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetSendersList;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetSendersList;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetSendersList");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public updateSender (senderId: number, sender?: UpdateSender, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/senders/{senderId}'
            .replace('{' + 'senderId' + '}', encodeURIComponent(String(senderId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(sender, "UpdateSender")
        };
...
export class TasksApi {
    ...
    public crmTasksGet (filterType?: string, filterStatus?: 'done' | 'undone', filterDate?: 'overdue' | 'today' | 'tomorrow' | 'week' | 'range', filterAssignTo?: string, filterContacts?: string, filterDeals?: string, filterCompanies?: string, dateFrom?: number, dateTo?: number, offset?: number, limit?: number, sort?: 'asc' | 'desc', sortBy?: string, options: any = {}) : Promise<{ response: AxiosResponse; body: TaskList;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: TaskList;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "TaskList");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmTasksIdDelete (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public crmTasksIdGet (id: string, options: any = {}) : Promise<{ response: AxiosResponse; body: Task;  }> {
        const localVarPath = this.basePath + '/crm/tasks/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: Task;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "Task");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmTasksIdPatch (id: string, body: Body7, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/crm/tasks/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body7")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public crmTasksPost (body: Body6, options: any = {}) : Promise<{ response: AxiosResponse; body: InlineResponse2011;  }> {
        const localVarPath = this.basePath + '/crm/tasks';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(body, "Body6")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: InlineResponse2011;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "InlineResponse2011");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public crmTasktypesGet (options: any = {}) : Promise<{ response: AxiosResponse; body: TaskTypes;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: TaskTypes;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "TaskTypes");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
...
export class TransactionalEmailsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public blockNewDomain (blockDomain: BlockDomain, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(blockDomain, "BlockDomain")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public createSmtpTemplate (smtpTemplate: CreateSmtpTemplate, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(smtpTemplate, "CreateSmtpTemplate")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteBlockedDomain (domain: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteHardbounces (deleteHardbounces?: DeleteHardbounces, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(deleteHardbounces, "DeleteHardbounces")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteScheduledEmailById (identifier: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteSmtpTemplate (templateId: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getAggregatedSmtpReport (startDate?: string, endDate?: string, days?: number, tag?: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetAggregatedReport;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetAggregatedReport;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetAggregatedReport");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getBlockedDomains (options: any = {}) : Promise<{ response: AxiosResponse; body: GetBlockedDomains;  }> {
        const localVarPath = this.basePath + '/smtp/blockedDomains';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetBlockedDomains;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetBlockedDomains");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
    ...
    public getEmailEventReport (limit?: number, offset?: number, startDate?: string, endDate?: string, days?: number, email?: string, event?: 'bounces' | 'hardBounces' | 'softBounces' | 'delivered' | 'spam' | 'requests' | 'opened' | 'clicks' | 'invalid' | 'deferred' | 'blocked' | 'unsubscribed' | 'error' | 'loadedByProxy', tags?: string, messageId?: string, templateId?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetEmailEventReport;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetEmailEventReport;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetEmailEventReport");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getScheduledEmailByBatchId (batchId: string, startDate?: string, endDate?: string, sort?: 'asc' | 'desc', status?: 'processed' | 'inProgress' | 'queued', limit?: number, offset?: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetScheduledEmailByBatchId;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetScheduledEmailByBatchId;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetScheduledEmailByBatchId");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getScheduledEmailByMessageId (messageId: string, startDate?: string, endDate?: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetScheduledEmailByMessageId;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetScheduledEmailByMessageId;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetScheduledEmailByMessageId");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
    ...
    public getSmtpReport (limit?: number, offset?: number, startDate?: string, endDate?: string, days?: number, tag?: string, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetReports;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetReports;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetReports");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getSmtpTemplate (templateId: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetSmtpTemplateOverview;  }> {
        const localVarPath = this.basePath + '/smtp/templates/{templateId}'
            .replace('{' + 'templateId' + '}', encodeURIComponent(String(templateId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: GetSmtpTemplateOverview;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetSmtpTemplateOverview");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getSmtpTemplates (templateStatus?: boolean, limit?: number, offset?: number, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetSmtpTemplates;  }> {
        const localVarPath = this.basePath + '/smtp/templates';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetSmtpTemplates;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetSmtpTemplates");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getTransacBlockedContacts (startDate?: string, endDate?: string, limit?: number, offset?: number, senders?: Array<string>, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetTransacBlockedContacts;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetTransacBlockedContacts;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetTransacBlockedContacts");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getTransacEmailContent (uuid: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetTransacEmailContent;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetTransacEmailContent;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetTransacEmailContent");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getTransacEmailsList (email?: string, templateId?: number, messageId?: string, startDate?: string, endDate?: string, sort?: 'asc' | 'desc', limit?: number, offset?: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetTransacEmailsList;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetTransacEmailsList;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetTransacEmailsList");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public sendTestTemplate (templateId: number, sendTestEmail: SendTestEmail, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(sendTestEmail, "SendTestEmail")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public sendTransacEmail (sendSmtpEmail: SendSmtpEmail, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateSmtpEmail;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(sendSmtpEmail, "SendSmtpEmail")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: CreateSmtpEmail;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "CreateSmtpEmail");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public smtpBlockedContactsEmailDelete (email: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public smtpLogMessageIdDelete (messageId: string, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public updateSmtpTemplate (templateId: number, smtpTemplate: UpdateSmtpTemplate, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/smtp/templates/{templateId}'
            .replace('{' + 'templateId' + '}', encodeURIComponent(String(templateId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(smtpTemplate, "UpdateSmtpTemplate")
        };
...
export class TransactionalSMSApi {
    ...
    public getSmsEvents (limit?: number, startDate?: string, endDate?: string, offset?: number, days?: number, phoneNumber?: string, event?: 'bounces' | 'hardBounces' | 'softBounces' | 'delivered' | 'sent' | 'accepted' | 'unsubscription' | 'replies' | 'blocked' | 'rejected', tags?: string, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetSmsEventReport;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetSmsEventReport;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetSmsEventReport");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getTransacAggregatedSmsReport (startDate?: string, endDate?: string, days?: number, tag?: string, options: any = {}) : Promise<{ response: AxiosResponse; body: GetTransacAggregatedSmsReport;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetTransacAggregatedSmsReport;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetTransacAggregatedSmsReport");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
    ...
    public getTransacSmsReport (startDate?: string, endDate?: string, days?: number, tag?: string, sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetTransacSmsReport;  }> {
        ...
        return new Promise<{ response: AxiosResponse; body: GetTransacSmsReport;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetTransacSmsReport");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public sendTransacSms (sendTransacSms: SendTransacSms, options: any = {}) : Promise<{ response: AxiosResponse; body: SendSms;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(sendTransacSms, "SendTransacSms")
        };
        ...
        return new Promise<{ response: AxiosResponse; body: SendSms;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "SendSms");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
...
export class WebhooksApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public createWebhook (createWebhook: CreateWebhook, options: any = {}) : Promise<{ response: AxiosResponse; body: CreateModel;  }> {
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(createWebhook, "CreateWebhook")
        };
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteWebhook (webhookId: number, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getWebhook (webhookId: number, options: any = {}) : Promise<{ response: AxiosResponse; body: GetWebhook;  }> {
        const localVarPath = this.basePath + '/webhooks/{webhookId}'
            .replace('{' + 'webhookId' + '}', encodeURIComponent(String(webhookId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: GetWebhook;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetWebhook");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public getWebhooks (type?: 'marketing' | 'transactional' | 'inbound', sort?: 'asc' | 'desc', options: any = {}) : Promise<{ response: AxiosResponse; body: GetWebhooks;  }> {
        const localVarPath = this.basePath + '/webhooks';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        const localVarFormParams: any = {};
        ...
        return new Promise<{ response: AxiosResponse; body: GetWebhooks;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetWebhooks");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
     ...
     * @param {*} [options] Override http request options.
     */
    public updateWebhook (webhookId: number, updateWebhook: UpdateWebhook, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/webhooks/{webhookId}'
            .replace('{' + 'webhookId' + '}', encodeURIComponent(String(webhookId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        const localVarRequestOptions: AxiosRequestConfig = {
            ...
            data: ObjectSerializer.serialize(updateWebhook, "UpdateWebhook")
        };
...
export class WhatsappCampaignsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteWhatsappCampaign (campaignId: any, options: any = {}) : Promise<{ response: AxiosResponse; body?: any;  }> {
    ...
    /**
     * 
     * @summary Get Whatsapp campaign Overview
     * @param campaignId Id of the campaign
     * @param {*} [options] Override http request options.
     */
    public getWhatsappCampaign (campaignId: any, options: any = {}) : Promise<{ response: AxiosResponse; body: GetWhatsappCampaignOverview;  }> {
        const localVarPath = this.basePath + '/whatsappCampaigns/{campaignId}'
            .replace('{' + 'campaignId' + '}', encodeURIComponent(String(campaignId)));
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: AxiosResponse; body: GetWhatsappCampaignOverview;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions).then((response) => {
                let {data} = response
                    data = ObjectSerializer.deserialize(data, "GetWhatsappCampaignOverview");
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        resolve({ response: response, body: data });
                    } else {
                        reject({ response: response, body: data });
